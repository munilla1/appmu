...
<%@ page import="app.com.example.Contador" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="contenedorRecursos">
	...
	<div class="contador">
		<img class="comida" src="frutas.png">
        Comida: ${sessionScope.contador.segundos}
	</div>
	
	<div class="contador">
		<img class="ejercicio" src="mancuerna.png">
		Ejercicio: ${sessionScope.contador.segundos}
	</div>
	
	<div class="contador">
		<img class="plata" src="moneda.png">
		Plata: ${sessionScope.contador.segundos}
	</div>
